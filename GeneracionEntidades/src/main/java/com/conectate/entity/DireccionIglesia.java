...
/**
 * The persistent class for the direccion_iglesia database table.
 * 
 */
@Entity
@Table(name="direccion_iglesia")
@NamedQuery(name="DireccionIglesia.findAll", query="SELECT d FROM DireccionIglesia d")
public class DireccionIglesia implements Serializable {
