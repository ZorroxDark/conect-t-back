...
public class CatNavegacion implements Serializable {
	...
	private byte exactMatch;

	@Column(name="external_link")
	private byte externalLink;
	...
	public byte getExactMatch() {
		return this.exactMatch;
	}

	public void setExactMatch(byte exactMatch) {
		this.exactMatch = exactMatch;
	}

	public byte getExternalLink() {
		return this.externalLink;
	}

	public void setExternalLink(byte externalLink) {
